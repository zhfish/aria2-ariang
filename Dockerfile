...
RUN apk update \
	...
	&& wget --no-check-certificate https://github.com/mayswind/AriaNg/releases/download/0.5.0/aria-ng-0.5.0.zip \
	&& unzip aria-ng-0.5.0.zip -d aria-ng \
	&& rm -rf aria-ng-0.5.0.zip
